...
export default function Home() {
  ...
  return <>
    ...
    {launches.length > 0 && <section className={`${styles.launches} section`}>
      <div className="shell"><header><span className="eyebrow">Novidades do portfólio</span><h2>Lançamentos Atual Pet</h2><Link className={`button button--outline button--small ${styles.actionButton}`} to="/produtos?lancamento=true">Ver lançamentos <ArrowRight size={16}/></Link></header>
